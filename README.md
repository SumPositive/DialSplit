...
- 多言語 UI（ja, de, en, es, fr, it, ko, zh-Hant）
...
| バージョン | 公開日 | 内容 |
|---|---|---|
| 2.3.0 | 2026-07-06 | 多言語対応（de, es, fr, it, ko, zh-Hant）、アプリアイコン刷新、iPad レイアウト調整 |
| 2.2.2 | 2026-07 | ダイアル設定を最新化しスタイル3種を追加、旧スタイルを刷新、パネルスタイルをシート化 |
| 2.2.1 | 2026-06 | 文字サイズ対応、ダイアルステッパー表示、端数の小数表示、パネルのコンパクト表示、Firebase Analytics / Crashlytics 導入 |
| 2.2.0 | 2026-06 | ローガンフリー（文字サイズ選択）、ダイアルステッパー表示、金額ダイアルステップの長押し変更を追加 |
